...
{
  Matrix<double, 6, 1> cf;
  Matrix<double, 3, 12> B;
  Matrix<double, 12, 1> gif;
  Matrix<double, 12, 22> gaf_dr_full;
  ...
  Matrix<double, 12, 7> gaf_dr_reduced;
  // Rear contact forces
  ...
  Matrix<double, 3, 3> B_d;
  Matrix<double, 3, 9> B_i;
  Matrix<double, 3, 7> gaf_dr_d;
  Matrix<double, 9, 7> gaf_dr_i;
